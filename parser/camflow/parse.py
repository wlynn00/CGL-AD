...
def read_single_graph(file_name):
    ...
    The last '<timestamp_stats>' may or may not exist.
    ...
    # graph.sort(compare_edges)  # python2
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--stats', help='record runtime graph generation speed (default is false)', action='store_true')
